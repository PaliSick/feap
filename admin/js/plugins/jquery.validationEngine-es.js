        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "number": {
                    ...
                    "regex": /^[\-\+]?[0-9]+(,[0-9]+)?$/,
                    "alertText": "* No es un valor decimal válido. No utilice separadores de miles y la coma como separador decimal "
                },
                "date": {
				...
				"noQuotes": {
					"regex": /^[^"']+$/,
					"alertText": "No se permiten comillas simples (') ni dobles (\")"
				}
            };
