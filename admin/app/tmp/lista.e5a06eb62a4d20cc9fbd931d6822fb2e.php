		...
		<div id="idp-panel-body">
			...
			<div id="idp-cfgpanel">
				...
				<div id="idp-cfgpanel-canvas">
					...
					<form action="http://idirecto.es/decoexsa/factura/lista" method="get" id="filter_products">
					...
					<table class="idp-table">
						...
						<tr class="<?php if( $key1%2 == 0 ){ ?>even<?php }else{ ?>odd<?php } ?>">
							...
							<td><a href="http://idirecto.es/decoexsa/pedidos/confirm/<?php echo $value1["id"];?>" class="confirm">Confirmar</a></td>
							<?php } ?>								
							<td><a href="http://idirecto.es/decoexsa/pedidos/details/<?php echo $value1["id"];?>" class="details">Ver</a></td>
						</tr>
						<?php }else{ ?>
