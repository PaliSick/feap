				...
				<div id="idp-cfgpanel-canvas">
					...
					<table class="idp-table">
						...
						<tr>
							...
							<img src="http://idirecto.es/decoexsa/../img_products/comodin.jpg" alt="<?php echo $value1["nombre"];?>" title="<?php echo $value1["nombre"];?>"> <?php echo $value1["nombre"];?>

							<?php }else{ ?>

							<img src="http://idirecto.es/decoexsa/../img_products/<?php echo $value1["img_name"];?>" alt="<?php echo $value1["nombre"];?>" title="<?php echo $value1["nombre"];?>"> <?php echo $value1["nombre"];?>
